...
public interface ConsultaRepository extends JpaRepository<Consulta, Long> {
    boolean existsByPacienteAndDataHoraBetween(Paciente paciente, LocalDateTime inicioDoDia, LocalDateTime finalDoDia);
    boolean existsByMedicoAndDataHora(Medico medico, LocalDateTime dataHora);
    boolean existsByMedicoAndDataHoraBetween(Medico medico, LocalDateTime inicio, LocalDateTime fim);
}
