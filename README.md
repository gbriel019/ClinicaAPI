...
> **Importante:** nunca envie ou versione o arquivo `.env` para o Git. Utilize o `.env.example` como modelo e preencha suas próprias informações.

## Configuração

O projeto possui um arquivo `.env.example` com as variáveis necessárias para configuração da aplicação.
